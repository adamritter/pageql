...
<script>
  ...
  function pupdatenode(i,v){var e=window.pageqlMarkers[i];if(!e)return;var t=document.createElement('template');t.innerHTML=v;var n=t.content.firstChild;if(!n)return;e.replaceWith(n);window.pageqlMarkers[i]=n;if(document.currentScript)document.currentScript.remove();}
